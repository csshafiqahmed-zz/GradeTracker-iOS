...
public class SCLAlertView: UIViewController, UITextFieldDelegate {
    ...
    let kWindowWidth: CGFloat = 235.0
    var kWindowHeight: CGFloat = 180
    ...
    override public func viewWillLayoutSubviews() {
        ...
        var y = (sz.height - windowHeight - (kCircleHeight / 8)) / 3
    ...
    func keyboardWillShow(notification: NSNotification) {
        ...
        //print(beginKeyBoardFrame)
        //print(endKeyBoardFrame)
    ...
    // Mark UITextFieldDelegateProtocol
